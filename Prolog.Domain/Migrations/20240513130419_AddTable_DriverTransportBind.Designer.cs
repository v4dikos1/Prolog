...
namespace Prolog.Domain.Migrations
{
    ...
    [Migration("20240513130419_AddTable_DriverTransportBind")]
    partial class AddTable_DriverTransportBind
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Prolog.Domain.Entities.DriverTransportBind", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("pk_driver_transport_driver");

                    b.HasIndex("DriverId")
                        .HasDatabaseName("ix_driver_transport_driver_driver_id");

                    b.HasIndex("TransportId")
                        .HasDatabaseName("ix_driver_transport_driver_transport_id");

                    b.ToTable("DriverTransportDriver", (string)null);
                });
            ...
            modelBuilder.Entity("Prolog.Domain.Entities.DriverTransportBind", b =>
                {
                    b.HasOne("Prolog.Domain.Entities.Driver", "Driver")
                        ...
                        .IsRequired()
                        .HasConstraintName("fk_driver_transport_driver_driver_driver_id");
                    ...
                    b.HasOne("Prolog.Domain.Entities.Transport", "Transport")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_driver_transport_driver_transports_transport_id");
